...
from unet3d.buildingblocks import DoubleConv, ResNetBlock, ResNetBlockSE, create_decoders, create_encoders
...
class AbstractUNet(nn.Module):
    ...
    def __init__(self, in_channels, out_channels, final_sigmoid, basic_module, f_maps=64, layer_order='gcr',
        ...
        if is_segmentation:
            ...
            #self.final_activation= nn.ReLU() # added by Alireza : regression to avoid negative predictions
    ...
    def forward(self, x):
        ...
        x_relued = F.relu(x)  # added by Alireza x_relued has size [b,c,d,h,w]
